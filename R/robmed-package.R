...
#' @docType package
#'
#' @title \packageTitle{robmed}
#'
#' @description \packageDescription{robmed}
#'
#' @details
#' The DESCRIPTION file:
#' \packageDESCRIPTION{robmed}
#' \packageIndices{robmed}
#'
#' @references
...
#'
#' @author
#' \packageAuthor{robmed}
#'
#' Maintainer: \packageMaintainer{robmed}
#'
#' @keywords package
